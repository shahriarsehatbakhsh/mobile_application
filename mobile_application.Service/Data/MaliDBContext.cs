...
namespace mobile_application.Service.Data
{
    public class MaliDBContext : DbContext
    {
        ...
        public DbSet<mobile_application.Service.Models.vw_result_long> vw_result_long { get; set; }
        public DbSet<mobile_application.Service.Models.vw_header_CodeSerial> vw_header_CodeSerial { get; set; }
        public DbSet<mobile_application.Service.Models.vw_JobNo> vw_JobNo { get; set; }
    }
}
